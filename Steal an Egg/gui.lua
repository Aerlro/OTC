...
Main.Size = UDim2.fromOffset(360, 210)
...
MainStroke.Color = Color3.fromRGB(35, 25, 15)
...
Title.Position = UDim2.new(0, 30, 0, 8)
...
Close.TextStrokeColor3 = Color3.fromRGB(20, 20, 20)
Close.ZIndex = 10
Close.Parent = Main
...
Container.Size = UDim2.new(1, -30, 0, 135)
...
local function CreateScriptCard(number)
    ...
    Card.Size = UDim2.fromOffset(105, 125)
    ...
    Stroke.Color = Color3.fromRGB(70, 45, 10)
    Stroke.Thickness = 2
    Stroke.Parent = Card

    -- Number
    local Number = Instance.new("TextLabel")
    Number.Size = UDim2.new(1, 0, 0, 45)
    Number.Position = UDim2.new(0, 0, 0, 3)
    ...
    Label.Position = UDim2.new(0, 4, 0, 43)
    Label.BackgroundTransparency = 1
    Label.Text = "SCRIPT " .. number
    ...
    Select.Size = UDim2.new(1, -14, 0, 32)
    Select.Position = UDim2.new(0, 7, 1, -39)
